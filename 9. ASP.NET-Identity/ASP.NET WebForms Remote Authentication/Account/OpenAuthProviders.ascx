<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="ASP.NET_WebForms_Remote_Authentication.Account.OpenAuthProviders" %>
